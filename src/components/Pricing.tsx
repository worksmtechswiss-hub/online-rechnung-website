...
const plans = [
  ...
  },
  {
    ...
    price: "CHF 30",
    period: "/ Monat",
    description: "Voller Zugriff auf alle Funktionen von Finitopro – für Freelancer und KMU die professionell arbeiten.",
    features: [
      "Alle Funktionen von Finitopro",
      "Unbegrenzte Rechnungen & Offerten",
      "QR-Rechnung inklusive",
      "Projekte & Zeiterfassung",
      "Alle Vorlagen & eigenes Logo",
      "Debitorenliste & Mahnwesen",
      "Serienrechnungen",
